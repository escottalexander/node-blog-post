...
describe("Blog Posts", function() {
    ...
    // "The Rabid Racoon", "Once upon a time, there lived a racoon named...", "Elliott Alexander"
    it("should add a blog post on POST", function() {
      const newItem = { title: "The Menacing Claw", content: "In a world where evil triumphs...", author: "Garbanzo ElBean" };
      return chai
        .request(app)
        .post("/blog-posts")
        .send(newItem)
